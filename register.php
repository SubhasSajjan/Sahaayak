  ...
  if(isset($_POST['submit'])) 
  {
     ...
     // $profileImage = upload_profile('./', $files);
      ...
      if($password == $cpassword) {
          $sql="SELECT * FROM helper WHERE email='$email'";
          ...
          if(!$result->num_rows>0){
			$sql="INSERT INTO helper (fname,lname,email,password,age,phone,gender,job,profileImage,address,city,exp,type,randomid,status) VALUES ('$fname','$lname','$email','$password','$age','$phone','$gender','$job','$image','$address','$city','$exp','$type','$randomid','0')";
            $result = mysqli_query($conn,$sql);
            if($result) {
                ...
                $gender = "";
                $to=$email;
                $subject="EmaiL Verification-SAHAYAAK";
                $message="Dear ".$fname." We Are Pleased To Welcome You To Our Family, Please Confirm The OTP To Confirm the account ".$randomid;
                $headers="From: ".$my_email;
                if(mail($to,$subject,$message,$headers)){
                    echo "<script>alert('We Have Sent OTP To Your Email-{$email}. ');</script>";
    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-black display-4" href="index.php">Home</a></li>
            ...
            <div class="upload-profile-image d-flex justify-content-center pb-5" style="margin-top:1%;margin-bottom:-2%;">
                ...
                <div class="d-flex justify-content-center" style="margin-bottom:10%;">
					...
					<!--<div class="form-row my-4">
                        ...
                        <div class="form-row my-4">
                            <div class="col">
                                <input type="text"  name="fname" id="fname" class="form-control" value = "<?php echo $fname; ?>" placeholder="First Name" style="background-color:#ffffff;" required autocomplete="off">
                                <!-- <span id = "error"> <?php echo $_POST['fname']="";?></span> -->
                            </div>
                        </div>
						...
						<div class="form-row my-4">
                            <div class="col">
                                <input type="text"  name="lname" id="lname" class="form-control" value = "<?php echo $lname; ?>" placeholder="Last Name" style="background-color:#ffffff;" required autocomplete="off">
                                <!-- <span id = "error"> <?php echo $_POST['lname']="";?></span> -->
                            </div>
                        </div>
                        ...
                        <div class="form-row my-4">
                            <div class="col">
                                ...
                                <!-- <span id = "error"> <?php echo $_POST['email']="";?></span> -->
                            </div>
                        </div>
                        ...
                        <div class="form-row my-4">
                            <div class="col">
                                ...
                                <!-- <span id = "error"> <?php echo $_POST['phone']="";?></span> -->
                        ...
                        <div class="form-row my-4">
                            <div class="col">
                                ...
                                <!-- <span id = "error"> <?php echo $_POST['password']="";?></span> -->
                            </div>
                        </div>
                        ...
                        <div class="form-row my-4">
                            <div class="col">
                                ...
                                <!-- <span id = "error">span> --> <?php $_POST['cpassword']="";?>
                            </div>
                        </div>
						
						<div class="form-row my-4">
                            <div class="col">
                                <input type="text"  name="address" id="address" class="form-control" value = "<?php echo $_POST['confirm_pwd']; ?>" placeholder="Address (House No. & Street/Colony)"  style="background-color:#ffffff;" required autocomplete="off">
                                <small id="confirm_error" class="text-danger"></small>
                                <!-- <span id = "error"> <?php echo $_POST['address']="";?></span> -->
                            </div>
                        </div>
						...
						<div class="form-row">
                            <div class="col">
								<select name="city" class="form-control" required>
									...
									<option value="Devi Camp">Devi Camp</option>
								</select>
						...
						<div class="form-row" style="margin-top:7%;">
                            <div class="col">
                              ...
                              <span id="ele">Electrician</span>-->
								...
								<option value="Plumbing">Plumbing&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</option>								
						...
						<div class="form-row my-4">
                            <div class="col" style="margin-bottom:-7%;"><b>Job-type:</b>&nbsp;&nbsp;&nbsp;
                              <input type="radio" name="type" id="part" value="P">
                              &nbsp;
                              <span id="part">Part-Time</span>
                              &nbsp;&nbsp;&nbsp;&nbsp;
                              <input type="radio" name="type" id="full" value="F">
                               &nbsp;
                              <span id="full">Full-Time</span>
                        ...
                        <div class="form-row my-4">
                            <div class="col" style="margin-bottom:-7%;"><b>Gender:</b>&nbsp;&nbsp;&nbsp;
